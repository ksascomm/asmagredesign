		<div class="row show-for-small black_bg">
			...
			<div class="mobile-logo centered">
				...
				<select title="Issue" class="bright_blue_bg issue" onchange="window.open(this.options[this.selectedIndex].value,'_top')">
		...
		<div class="row hide-for-print hide-for-small">
			<div id="search-bar" class="small-4 medium-7 medium-offset-5 columns">
				<div class="row">
				<div id="search_links" class="small-2 medium-8 columns links inline hide-for-mobile">
			...
			<div class="small-12 columns" id="logo_nav">
				<li class="logo"><a href="<?php echo home_url(); ?>" title="Krieger School of Arts & Sciences"><span class="hide">Arts & Sciences</span></a>
				<select title="Issue" class="issue" onchange="window.open(this.options[this.selectedIndex].value,'_top')">
			...
			<form action="#" class="row hide-for-print"  id="fields_search" role="search">
				<fieldset class="radius10">
					...
					<div class="medium-7 medium-offset-3 columns filter hide-for-mobile option-set" data-filter-group="structure">
					...
					<div class="small-2 columns offset-gutter">
