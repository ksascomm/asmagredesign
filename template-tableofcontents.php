...
<div id="container-mid">
	...
	set_transient( 'front_features' . $volume . '_query', $asmag_feature_query, 86400 ); } 
			...
			while ($asmag_feature_query->have_posts()) : $asmag_feature_query->the_post(); 
				...
				<div class="small-12 medium-4 large-3 columns mobile-field features box <?php echo $category_name; if(!empty($multimedia_name)) { echo ' ' . $multimedia_name; } ?>">
			...
			?>
				...
				<!-- Set classes for isotype.js filter buttons -->
				<div class="small-12 medium-3 columns mobile-field box <?php echo $category_name; if(!empty($multimedia_name)) { echo ' ' . $multimedia_name; } ?>">
